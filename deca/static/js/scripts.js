...
let timerInterval;let time=55;function updateTime(){var rnd=Math.floor(Math.random()*(5-1))+5;time=time+rnd;if(time>5555){time=5555;}
...
window.addEventListener('load',()=>{time=parseInt(localStorage.getItem('dfdx'));if(isNaN(time))time=2000
